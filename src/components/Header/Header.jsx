...
export default function Header() {
    ...
    useEffect(() => {
        ...
        if (index !== undefined) {
            ...
            setSelectedPerso(0); // default to first image if path is not found
        }
    }, [location]);
    ...
    return (
        <header className='Header'>
            ...
            <img key={selectedPerso} src={perso[selectedPerso]} alt={`Perso ${selectedPerso + 1}`} className={`perso-${selectedPerso + 1}`} />
        </header>
    );
}
