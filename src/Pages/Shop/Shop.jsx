...
export default function Shop() {
  ...
  return (
    ...
    >
      {!selectedAlbum && (
        <section className={`album__choice-container ${selectedAlbum === null ? 'empty-bg' : ''}`}>
          <img
            src={sleepwel}
          ...
          <img
            ...
            alt="It Could Album"
          />
          <div className="empty-bg" alt="Empty Background" />
        </section>
      )}
        ...
        <section className="album__details-container">
          {selectedAlbum === 'sleepwel' && (
            <section className="album__details">
              <img className="detail-img" src={detailSleep} alt="Sleepwell Details" />
          ...
          {selectedAlbum === 'itcould' && (
            <section className="album__details">
              <img className="detail-img" src={detailIt} alt="It Could Details" />
              <div className="album__navigation">
                <img onClick={handleReturn} src={fleche} alt="Arrow" />
                <div>
                  <p>Ecouter</p>
